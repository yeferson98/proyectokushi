...
class Colors {
  ...
  Color _mainDarkColor = Color.fromRGBO(64, 16, 101, 9.0);
  Color _secondColor = Color(0xFF6F35A5);
  Color _secondDarkColor = Color(0xFFEDE7F6);
  Color _accentColor = Color(0xFFD1C4E9);
  Color _accentDarkColor = Color(0xFFD1C4E9);
